...
class AutoGlowView(ctk.CTkFrame):
    ...
    def run_install(self):
        ...
        script = f"rm -rf {self.autoglow_dir}; cd {self.user_home}; git clone https://github.com/IteraThor/AutoGlow.git; chown -R {user}:{user} {self.autoglow_dir}; cd {self.autoglow_dir}; chmod +x setup.sh; ./setup.sh"
