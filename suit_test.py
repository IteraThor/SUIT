...
sudo apt-get update
# python3-venv und git installieren (wichtig für venv Fehler)
...
# WICHTIG: Besitzrechte auf den aktuellen Benutzer übertragen, damit Schreibzugriff geht
...
if [ -f "$TARGET/setup.sh" ]; then
    ...
    # Setup als normaler User starten
    "$TARGET/setup.sh"
else
