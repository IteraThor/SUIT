...
def check_system_dependencies():
    ...
    if missing:
        ...
        print("[!] Please run: sudo apt install python3-tk python3-dev libdbus-1-dev git libglib2.0-dev build-essential")
        return False
    return True
...
def setup_environment():
    ...
    print("[*] Upgrading core build tools (pip, setuptools, wheel)...")
